  ...
  return (
    <div className="container w-full h-min-screen m-auto mt-16 p-8">
      <div className="w-[600px] m-auto">
        <div className="flex flex-col space-y-12 p-8 text-gray-600">
          <h1 className="md:text-4xl text-xl font-extrabold tracking-widest text-center">
            新規登録
          </h1>
          <div className="grid gap-8">
            <div className="grid gap-1">
              <p className="md:text-md text-sm tracking-widest font-semibold">
                メールアドレス
              </p>
              <input
                type="text"
          ...
          <div className="flex justify-between">
            ...
            <button className="md:py-4 py-2 md:px-8 px-4 bg-blue-500 text-slate-50 rounded-lg hover:bg-blue-700 md:text-xl text-md md:w-[200px] w-[150px]">
              登録
            </button>
          </div>
